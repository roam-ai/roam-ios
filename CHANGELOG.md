...
We're excited to introduce Roam iOS SDK version 0.1.30, bringing improvements to tracking accuracy and customization options. Here's what's new:
...
We're excited to introduce Roam iOS SDK version 0.1.31, bringing new enhancements for greater customization. Here's what's new:

**Data Enhancements Additions:**
Introduced several new parameters to provide more flexibility and control over data handling.

These updates aim to enhance the SDK's customization capabilities and overall user experience. If you have any questions or feedback, our support team is here to assist.
...
- Real-time Geofence Events: Detect entry and exit events instantly for better contextual triggers.
...
**Enhancements in Data Enrichment, SDK Performance, and Tracking Quality**We're excited to introduce Roam iOS SDK version 0.1.34, focused on enriching data output, optimizing performance, and elevating the quality of location tracking. Here's what's new:

- **New Data Enrichment Fields**: We've added new data enrichment attributes to offer greater customization and more insightful location metadata.
- **SDK Performance Optimization**: Key internal improvements have been made to streamline performance and reduce resource usage.
...
We're thrilled to present Roam iOS SDK version 0.2.0, focusing on improving the overall quality and performance of the SDK. In this update, we've made the following enhancements:
