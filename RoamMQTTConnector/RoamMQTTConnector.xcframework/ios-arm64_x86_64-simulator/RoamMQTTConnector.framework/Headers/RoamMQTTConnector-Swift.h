...
#ifndef ROAMMQTTCONNECTOR_SWIFT_H
#define ROAMMQTTCONNECTOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RoamMQTTConnector",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("MqttConnectorLocationData")
...
SWIFT_PROTOCOL("_TtP17RoamMQTTConnector13RoamConnector_")
@protocol RoamConnector
@property (nonatomic, readonly, copy) NSString * _Nonnull clientID;
@end

@protocol RoamMQTTDelegate;

SWIFT_CLASS("_TtC17RoamMQTTConnector17RoamMQTTConnector")
@interface RoamMQTTConnector : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) id <RoamMQTTDelegate> _Null_unspecified delegate;)
+ (id <RoamMQTTDelegate> _Null_unspecified)delegate SWIFT_WARN_UNUSED_RESULT;
+ (void)setDelegate:(id <RoamMQTTDelegate> _Null_unspecified)value;
...
@interface RoamMQTTConnector (SWIFT_EXTENSION(RoamMQTTConnector)) <LocationSubscriber>
...
SWIFT_PROTOCOL("_TtP17RoamMQTTConnector16RoamMQTTDelegate_")
@protocol RoamMQTTDelegate
@optional
...
SWIFT_CLASS("_TtC17RoamMQTTConnector22RoamMqttConnectOptions")
...
SWIFT_CLASS("_TtCC17RoamMQTTConnector17RoamMqttConnector7Builder")
...
SWIFT_CLASS("_TtC17RoamMQTTConnector19RoamMqttWillOptions")
