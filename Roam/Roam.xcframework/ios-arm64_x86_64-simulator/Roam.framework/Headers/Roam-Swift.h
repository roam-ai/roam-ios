...
SWIFT_PROTOCOL("_TtP4Roam18LocationSubscriber_")
@protocol LocationSubscriber
- (void)receiveLocationUpdateWithLocation:(CLLocation * _Nonnull)location dictionary:(NSDictionary<NSString *, id> * _Nonnull)dictionary;
- (void)connect;
- (void)disconnect;
@end
...
SWIFT_CLASS("_TtC4Roam21RoamLocationPublisher")
@interface RoamLocationPublisher : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
